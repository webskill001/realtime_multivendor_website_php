                            ...
                            <div class="col-md-8 col-sm-7 col-xs-12">
                                <figure>
                                    <div class="flexslider single-portfolio-slider">
                                        <ul class="slides">
                                            <li><img src="images/portfolio/classic/portfolio6.jpg"
                                                    class="img-responsive" alt="Portfolio item 6"></li>
                                            <li><img src="images/portfolio/classic/portfolio4.jpg"
                                                    class="img-responsive" alt="Portfolio item 4"></li>
                                            <li><img src="images/portfolio/classic/portfolio3.jpg"
                                                    class="img-responsive" alt="Portfolio item 3"></li>
                                        </ul>
                                    </div>
                                </figure>
                            </div>
